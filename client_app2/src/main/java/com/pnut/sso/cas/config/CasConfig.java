...
public class CasConfig {
    ...
    public FilterRegistrationBean filterValidationRegistration() {
        ...
        initParameters.put("serverName", CasProperties.SERVER_NAME);
    ...
    public FilterRegistrationBean filterAuthenticationRegistration() {
        ...
        registration.addUrlPatterns("/*");
        initParameters.put("casServerLoginUrl", CasProperties.CAS_SERVER_LOGIN_PATH);
        initParameters.put("serverName", CasProperties.SERVER_NAME);
        ...
        // 表示过滤所有
        initParameters.put("ignoreUrlPatternType", "com.pnut.sso.cas.auth.SimpleUrlPatternMatcherStrategy");
